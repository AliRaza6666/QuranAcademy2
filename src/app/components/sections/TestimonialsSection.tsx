...
export function TestimonialsSection() {
  return (
    <section className="bg-accent/20 py-32 rounded-t-3xl">
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-4xl font-extrabold font-headline text-primary mb-4">Voices from Our Community</h2>
            <p className="text-surface-foreground text-lg">Experience the transformative power of spiritual learning through the eyes of our dedicated students.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-white rounded-2xl p-10 shadow-sm border border-accent/10 flex flex-col h-full">
