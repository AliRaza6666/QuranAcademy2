    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32">
      <div className="bg-primary rounded-3xl overflow-hidden relative">
        ...
        <div className="relative z-10 p-5 sm:p-8 md:p-12 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-extrabold font-headline text-primary-foreground mb-8 max-w-3xl mx-auto">
            Ready to Begin Your Sacred Journey?
          </h2>
          <p className="text-primary-foreground/80 text-base sm:text-lg md:text-xl mb-12 max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a
              href="/contact"
              className="bg-accent text-accent-foreground px-6 py-4 sm:px-10 sm:py-5 lg:px-12 rounded-xl font-headline font-extrabold text-base sm:text-lg md:text-xl hover:bg-accent/90 transition-all text-center"
            >
              Book Free Trial
            </a>
            <a
              href="/contact"
              className="bg-transparent border-2 border-primary-foreground text-primary-foreground px-6 py-4 sm:px-10 sm:py-5 lg:px-12 rounded-xl font-headline font-bold text-base sm:text-lg md:text-xl hover:bg-primary/10 transition-all text-center"
            >
              Talk to Us
            </a>
          </div>
